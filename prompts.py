...
def gen_location_prompt(worldInfo):
...
+''', exactly as written. Again, it's only necessary to do this if the character has just now changed clothes from what they had on previously.
    ...
    Output: <span style=\"color: [hex code];\">[Charname]</span> comes up to you. <span style=\"color: [hex code];\">[Charname]: \"Hello!\"</span>... [try to keep this Output under 400 characters].
END OUTPUT
...
+''', exactly as written. Again, it's only necessary to do this if the character is just now changing clothes from what they had on.
    ...
    Output: <span style=\"color: [hex code];\">[Charname]</span> comes up t you. <span style=\"color: [hex code];\">[Charname]: \"Hello!\"</span>... [try to keep this Output under 400 characters].
END OUTPUT
Character Leaving: Character 2
Character Leaving: Character 4
Character Emotion 1: emotion
