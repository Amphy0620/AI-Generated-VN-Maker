...
from prompts import prompt_input_instructions

def gen_text_prompt(promptJSON, model, jailbreak, prefill, boolRomanticProgression, clothingNamesStr, emotionNamesStr):
    ...
    instructions = prompt_input_instructions(boolRomanticProgression, clothingNamesStr, emotionNamesStr)
...
if __name__ == "__main__":
    if len(sys.argv) > 7:
        ...
        response_data = gen_text_prompt(promptJSON, model, jailbreak, prefill, boolRomanticProgression, clothingNamesStr, emotionNamesStr)
        print(response_data)
