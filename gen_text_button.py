...
def gen_text_button(promptJSON, model, jailbreak, boolRomanticProgression):
...
if __name__ == "__main__":
    if len(sys.argv) > 4:
        ...
        response_data = gen_text_button(promptJSON, model, jailbreak, boolRomanticProgression)
        print(response_data)