...
def gen_text_button(promptJSON, model, jailbreak, prefill, boolRomanticProgression):
...
if __name__ == "__main__":
    if len(sys.argv) > 5:
        ...
        response_data = gen_text_button(promptJSON, model, jailbreak, prefill, boolRomanticProgression)
        print(response_data)
